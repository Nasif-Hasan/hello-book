    ...
    return (
        <section>
            <div class="max-w-screen-xl px-4 py-8 mx-auto sm:px-6 sm:py-12 lg:px-8">
                ...
                <ul class="grid grid-cols-1 mx-auto gap-4 mt-8 lg:grid-cols-3">
                    <li>
                            ...
                            <div className="flex items-center justify-between p-3">
                                <div className="flex items-center space-x-2">
                                    ...
                                    <div className="-space-y-1">
                                        <h2 className="text-sm font-semibold leading-none">Nasif Hasan</h2>
                                        <span className="inline-block text-xs leading-none dark:text-gray-400">Bangladesh</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-wrap items-center pt-3 pb-1">
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <span className="text-sm">Liked by
                                            <span className="font-semibold"> Nasif Hasan </span>and
                                            <span className="font-semibold"> 6 others</span>
                                        </span>
                                    </div>
                                </div>
                                <div className="space-y-3">
                                    <p className="text-sm">
                                        <span className="text-base font-semibold">Post Text </span>Nemo ea quasi debitis impedit!
                                    </p>
